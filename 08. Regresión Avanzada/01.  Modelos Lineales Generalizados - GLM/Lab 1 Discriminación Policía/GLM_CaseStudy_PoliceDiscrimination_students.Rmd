...
Arrests %>% 
  ggplot(aes(x = released, y = age, fill = sex)) + 
  geom_boxplot() +
...
Arrests %>% 
  ggplot(aes(x = released, y = colour)) + 
  geom_jitter(col="lightblue") +
  labs(title = "Released by race", x = "", y = "", col = "")
...
- family: probability distribution of the response (default option is normal, other options are: binomial, poisson, gamma, etc.)
...
- binomial(link = "logit") # binomial en R significa también Bernoulli
