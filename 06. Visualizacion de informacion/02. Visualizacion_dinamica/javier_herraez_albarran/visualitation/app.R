...
require(scales)
source('functions.R')
# setwd('C:/Users/jherraez/Documents/masterAFI/06. Visualizacion de informacion/02. Visualizacion_dinamica/javier_herraez_albarran/visualitation')
# setwd('C:/Users/Javier/Documents/masterAFI/06. Visualizacion de informacion/02. Visualizacion_dinamica/javier_herraez_albarran/visualitation')
...
teams <- sort(unique(nba_df$team_name))
