...
plot_evolution <- function(evolution){
  plot(1:evolution$dias, evolution$contagiados, 
       type = 'l', col = 'red',
       ylab = 'Nº Personas', xlab = 'Días', 
       ylim = c(0, max(evolution$susceptibles)))
  lines(1:evolution$dias, evolution$recuperados, 
        type = 'l', col="green")
  lines(1:evolution$dias, evolution$susceptibles, 
        type = 'l', col="blue")
...
plot_new_infections <- function(list_new_infections, dias){
  plot(1:dias, list_new_infections, 
