...
```{r}
# Add here your own graphs
boxplot(AirlinesTrain$TotalDelay)

```

Half of the observations have a TotalDelay==0
...
```{r}
# Type here a simple regression model
...
```{r}
# Type here the corresponding prediction in testing
...
sqrt(mean(((exp(pred.log)-10) - AirlinesTest$TotalDelay)^2))
