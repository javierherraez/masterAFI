...
Not a very clear relation with age
...
Not a very clear relation with race
...
Very clear relation with previous checks
...
- however for older people, blacks were treated less severely than whites 
...
Our GLM is controlling (adjusting) for all other factors simultaneously while the journal is controlling for each one at a time
